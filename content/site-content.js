window.SITE_CONTENT = {
  ...
  advisors: {
    ...
    items: [
      {
        name: "郑千惠 Qianhui Zheng",
        role: { zh: "大四ME+CS专业", en: "Senior student majoring in ME and CS" },
        email: "zhengqianhui@sjtu.edu.cn",
        expertise: [
          { zh: "选课规划", en: "Course selection planning" },
          { zh: "DD美研申请", en: "Dual Degree program application" },
        ],
        bio: {
          zh: "外冷内热的INFJ",
	...
	role: { zh: "大四ME+CS专业", en: "Senior student majoring in ME and CS" },
        ...
        expertise: [
          { zh: "DD申请", en: "Dual Degree program application" },
          { zh: "学业之外的规划", en: "planing beyong academics" },
        ],
        bio: {
          zh: "快来给我一个聊天摆烂的机会",
	...
	role: { zh: "大四ME+CS专业", en: "Senior student majoring in ME and CS" },
        ...
        expertise: [
          { zh: "DD美研申请", en: "Application for Dual Degree program and graduate studies in the United States" },
        ],
        bio: {
          zh: "人机但是喜欢聊天的ISTJ",
          en: "A robotic ISTJ who like chatting",
        },
      },
      {
        name: "戴琤妍",
	role: { zh: "大二ECE专业", en: "Sphomore student majoring in ECE" },
        email: "cheryl_cy@sjtu.edu.com",
        expertise: [
