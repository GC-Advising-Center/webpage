window.SITE_CONTENT = {
  ...
  advisors: {
    ...
    // 重新设计为 5 个大类（老师、大四/研究生、大三、大二、大一）以便于前端做手风琴/折叠面板效果
    groups: [
      {
        id: "faculty",
        title: { zh: "教师团队", en: "Faculty & Professors" },
        items: [
          {
            name: "班雨桐",
      ...
      {
        id: "senior",
        title: { zh: "大四及研究生", en: "Seniors & Postgraduates" },
        items: [
          {
            name: "倪银晨",
